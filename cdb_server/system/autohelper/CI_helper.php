 ...
 * @property CI_encryption $encryption            Provides two-way keyed encoding using XOR Hashing and Mcrypt
 ...
 * @property x2a                $x2a
 * @property getui              $getui
 * @property page               $page
 * @property area               $area
 * @property gps                $gps
 * @property pexcel             $pexcel
 * @property alipay             $alipay
 * @property userevent          $userevent
 * @property cdbx               $cdbx
 * @property wx                 $wx
 * @property wxreceive          $wxreceive
 * @property wxcpt              $wxcpt
 */
class CI_Controller{}
