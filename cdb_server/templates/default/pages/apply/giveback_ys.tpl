...
<div class="page-giveback-box">
    <div class="simple-box">
        ...
        <p class="color-red">门店编号：<em>88{#zerofill($orderinfo['retuserid'], 8)#}</em></p>
    ...
    <div class="detail-box">
        ...
        <p>门店编号：<em>88{#zerofill($orderinfo['retuserid'], 8)#}</em></p>

        <p>借用押金：<em><del>29元</del> <font color="red">免押金</font></em></p>
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-after">
                                        ...
                                        {#elseif $myordersale[0]['sale_type'] == 'P'#}
                                            {#intval((100 - $myordersale[0]['sale']) / 10)#}折优惠
...
<div class="page-giveback-tis">
    请正确核对<span class="color-red"> 门店编号 </span>及<span class="color-red"> 归还门店 </span>？
</div>
...
<script>
    $JS = {
        ...
        givebacksale: function() {
            ...
            $JS.saleMessage = "使用{#sale_name()#}抵扣:<span class='saleBigOrange'>" + (retmoney - truemoney) + "</span>元<br/>" +
