...
<div id="dcWrap">
    ...
    {#tpl('_top')#}
    <!-- dcHead 结束 -->
    {#tpl('_left', 'users_money')#}


    <div id="dcMain">
        <!-- 当前位置 -->
        <div id="urHere">管理中心<b>&gt;</b><strong>会员余额账户</strong> </div>
        <div id="index" class="mainBox" style="padding-top:18px;height:auto!important;min-height:550px;">
            ...
            <div class="idTabs">
                <ul class="tab">
                    <li><a href="#main">余额记录</a></li>
                    <li><a href="#change">余额操作</a></li>
                </ul>
                <div class="items">
                            ...
                            {#foreach from=$lists['list'] item=item#}
                                <tr data-id="{#$item.id#}" data-img="{#$item.userimg|fillurl#}" data-username="{#$item['username']#}">
                                    ...
                                    <td align="center">
                                        {#if $rolofromid#}
                                            {#if $item['from_id']#}
                                                <a href="{#url('admin/users_money')#}?userid={#$item['from_id']#}" title="点击查看推广员账户记录">{#$item['from_id']#}</a>
                                            {#else#}
                                                -
                                            {#/if#}
                                        {#else#}
                            ...
                            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic tableAuto">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label style="margin-left:5px;"><input type="checkbox" class="check" name="addplus" value="1" checked>同时增减到不可提现余额</label>　
